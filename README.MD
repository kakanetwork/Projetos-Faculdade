...
<ul>
  <li><code>projeto1.py</code>: Projeto que faz uso de bibliotecas de rede em Python para criação de um scanner de portas.</li>
  <li><code>projeto2.py</code>: Projeto que implementa algoritmos de roteamento em Python para redes.</li>
  <li><code>projeto3.py</code>: Projeto que utiliza a biblioteca Pandas para manipulação de dados em Python.</li>
  <li><code>projeto4.py</code>: Projeto que faz uso de bibliotecas de visualização de dados em Python para criação de gráficos.</li>
</ul>
<h2 align="center">🚀 Como utilizar</h2>
<p align="center">
    Para utilizar os projetos, basta ter o Python instalado na sua máquina e executar o comando <code>python nome_do_projeto.py</code> no terminal para rodá-lo.
</p>
